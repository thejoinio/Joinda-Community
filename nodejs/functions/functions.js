...
class FunctionsUtils {
    ...
    async Wo_GetReactionsTypes(ctx,type = 'page') {
        ...
        result.forEach(element => {
            ...
            if (type == 'page') {
                if (element.joinda_icon && element.joinda_icon != '' && element.joinda_icon !== undefined) {
                    (async () => {
                    element.joinda_icon = element.joinda_small_icon = await this.Wo_GetMedia(ctx,element.joinda_icon);
                    })();
                    element.is_html = 0;
                }
                else if (!fs.existsSync(path.resolve('../themes/',ctx.globalconfig["theme"]+'/reaction/like-sm.png'))) {
                    if (element.id == 1) {
                        element.joinda_icon = '<div class="emoji emoji--like"><div class="emoji__hand"><div class="emoji__thumb"></div></div></div>';
                    }
                    if (element.id == 2) {
                        element.joinda_icon = '<div class="emoji emoji--love"><div class="emoji__heart"></div></div>';
                    }
                    if (element.id == 3) {
                        element.joinda_icon = '<div class="emoji emoji--haha"><div class="emoji__face"><div class="emoji__eyes"></div><div class="emoji__mouth"><div class="emoji__tongue"></div></div></div></div>';
                    }
                    if (element.id == 4) {
                        element.joinda_icon = '<div class="emoji emoji--wow"><div class="emoji__face"><div class="emoji__eyebrows"></div><div class="emoji__eyes"></div><div class="emoji__mouth"></div></div></div>';
                    }
                    if (element.id == 5) {
                        element.joinda_icon = '<div class="emoji emoji--sad"><div class="emoji__face"><div class="emoji__eyebrows"></div><div class="emoji__eyes"></div><div class="emoji__mouth"></div></div></div>';
                    }
                    if (element.id == 6) {
                        element.joinda_icon = '<div class="emoji emoji--angry"><div class="emoji__face"><div class="emoji__eyebrows"></div><div class="emoji__eyes"></div><div class="emoji__mouth"></div></div></div>';
                    }
                    element.joinda_small_icon = '';
                    element.is_html = 1;
                }
    ...
    async Wo_GetPostReactions(ctx,object_id, col = "post",type = '') {
       ...
       if(reactions && reactions !== undefined){
            ...
            reactions.forEach(element => {
                ...
                if (ctx.reactions_types[element].joinda_small_icon && ctx.reactions_types[element].joinda_small_icon !== undefined && ctx.reactions_types[element].joinda_small_icon != '') {
                    reactions_html += first+"<div class='inline_post_count_emoji reaction'><img src='"+ctx.reactions_types[element].joinda_small_icon+"' alt=\""+ctx.reactions_types[element].name+"\"></div></span>";
                }
