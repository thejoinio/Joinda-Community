...
function Wo_GetReactionsTypes($type = "page") {
    ...
    if (!empty($reactions)) {
        while ($fetched_data = mysqli_fetch_assoc($reactions)) {
            ...
            if ($type == "page") {
                if (!empty($fetched_data["joinda_icon"])) {
                    $fetched_data["joinda_icon"] = $fetched_data["joinda_small_icon"] = Wo_GetMedia($fetched_data["joinda_icon"]);
                    // $explode2  = @end(explode('.', $fetched_data['joinda_icon']));
                    // $explode3  = @explode('.', $fetched_data['joinda_icon']);
                    // $fetched_data['joinda_small_icon'] = $explode3[0] . '_small.' . $explode2;
                    $fetched_data["is_html"]       = 0;
                } elseif (!file_exists("./themes/" . $wo["config"]["theme"] . "/reaction/like-sm.png")) {
                    if ($fetched_data["id"] == 1) {
                        $fetched_data["joinda_icon"] = '<div class="emoji emoji--like"><div class="emoji__hand"><div class="emoji__thumb"></div></div></div>';
                    }
                    if ($fetched_data["id"] == 2) {
                        $fetched_data["joinda_icon"] = '<div class="emoji emoji--love"><div class="emoji__heart"></div></div>';
                    }
                    if ($fetched_data["id"] == 3) {
                        $fetched_data["joinda_icon"] = '<div class="emoji emoji--haha"><div class="emoji__face"><div class="emoji__eyes"></div><div class="emoji__mouth"><div class="emoji__tongue"></div></div></div></div>';
                    }
                    if ($fetched_data["id"] == 4) {
                        $fetched_data["joinda_icon"] = '<div class="emoji emoji--wow"><div class="emoji__face"><div class="emoji__eyebrows"></div><div class="emoji__eyes"></div><div class="emoji__mouth"></div></div></div>';
                    }
                    if ($fetched_data["id"] == 5) {
                        $fetched_data["joinda_icon"] = '<div class="emoji emoji--sad"><div class="emoji__face"><div class="emoji__eyebrows"></div><div class="emoji__eyes"></div><div class="emoji__mouth"></div></div></div>';
                    }
                    if ($fetched_data["id"] == 6) {
                        $fetched_data["joinda_icon"] = '<div class="emoji emoji--angry"><div class="emoji__face"><div class="emoji__eyebrows"></div><div class="emoji__eyes"></div><div class="emoji__mouth"></div></div></div>';
                    }
                    $fetched_data["joinda_small_icon"] = "";
                ...
                // if (!empty($fetched_data['joinda_icon']) && !empty($fetched_data['sunshine_icon'])) {
                //     $fetched_data['sunshine_icon'] = Wo_GetMedia($fetched_data['sunshine_icon']);
                //     $fetched_data['joinda_icon'] = Wo_GetMedia($fetched_data['joinda_icon']);
                // }
                // else{
